...
import net.sf.marineapi.ais.sentence.AISMessage03;
 ...
 * @author Lázár József
 */
public class AISMessage03Parser extends AISPositionReportParser implements AISMessage03 {

	public AISMessage03Parser(Sixbit content) throws Exception {
		super(content);
	}
}
