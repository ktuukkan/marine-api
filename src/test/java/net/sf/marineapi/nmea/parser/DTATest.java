...
public class DTATest {
    ...
    public static final String EXAMPLE_MC = "$GFDTA,1,1.5,99,600,11067,2002/03/01 00:30:28,HF-1xxx,1,*10";	

    public static final String EXAMPLE2 = "$GFDTA,7.7,98,600,5527,2011/01/27 13:29:28,HFH2O-1xxx,1,*07";
    ...
    public void testDTAParserTalkerId() {
    	DTAParser mwdp = new DTAParser(TalkerId.GF, 6);
