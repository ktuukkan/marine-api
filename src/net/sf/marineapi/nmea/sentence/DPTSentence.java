...
/**
 * Depth of water, in meters. Includes offset to transducer, positive values for
 * distance from transducer to water line and negative values for distance from
 * transducer to keel.
 * 
